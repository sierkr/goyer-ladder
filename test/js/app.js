...
import { renderAdmin, renderAdminSpelersEnAccounts, openAddPlayer,
  ...
  slaProfielHcpOp, kiesWeergave, renderAdminUsers, openEditUser, saveEditUser,
  ...
  renderUiStijlKaart, kiesUiStijl } from './admin.js';
...
import { renderToernooi, herlaadToernooien, selecteerToernooi, gaNaarToernooiOverzicht,
  ...
  selecteerDag, selecteerSpelersTab, openNieuweDagModal, voegDagToe, sluitDagAf, renderDagBlokken,
  voegTeamToe, hernoemTeam, verwijderTeam, zetSpelerTeam, zetTeamTelling, zetTeamBesteN } from './toernooi.js';
...
// v5.18.0: de vijf bulk-import functies stonden hier. Weg; zie js/admin.js.
...
window.kiesWeergave = kiesWeergave; // v5.6.0
...
// v5.42.0 — teams in een toernooi
window.voegTeamToe = voegTeamToe;
window.hernoemTeam = hernoemTeam;
window.verwijderTeam = verwijderTeam;
window.zetSpelerTeam = zetSpelerTeam;
window.zetTeamTelling = zetTeamTelling;
window.zetTeamBesteN = zetTeamBesteN;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.login-versie').forEach(el => {
    ...
    if (IS_TEST) {
      el.style.color = '#c2410c'; // v5.28.0: was #ff6b35 — 2,84 : 1 op wit
